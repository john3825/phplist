...
<br>ほとんどのメールソフトで、これは from <b>information@<?php echo $domain?></b>となって表されます。
...
<br>ほとんどのメールソフトで、これは、from <b>list information</b>となって表されます。
...
<br>ほとんどのメールソフトで、これは、from <b>My Name</b>となって表されます。
