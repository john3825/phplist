...
$lan = array(
  ...
  'passwordsent' => 'パスワードをメールで送信しました。',
  'cannotsendpassword' => 'パスワードを送信することができません。',
  'ipchanged' => 'IPアドレスが変更されました。セキュリティーの理由により、ログインし直す必要があります。',
  'goodbye' => 'おつかれさまでした。',
  ...
  'noxml' => 'RSS機能を利用するためには、XMLライブラリをインクルードする必要があります。',
  ...
  'nofpdf' => 'FPDFをロードすることなしにPDFサポートを使うことを試しています。',
  'warnpageroot' => 'ページルートの設定は、現在のロケーションとマッチしません。<br />設定ファイルをチェックしてください。',
  'pagenotfoundinplugin' => 'このページはプラグインにみつかりませんでした。',
  'notimplemented' => 'まだ導入されていません。',
  'noaccess' => 'このページにアクセスする十分な権限を持っていません。',
  'nohelpavailable' => 'このトピックのヘルプはまだ利用できません。: ',
  'closewindow' => 'このウィンドウを閉じる',
  'success' => '成功',
  'failed' => '失敗',
  'default login is' => 'デフォルトのログイン名は',
  'with password' => 'デフォルトのパスワードは',
  'name' => '名前',
  'password' => 'パスワード',
  'enter' => 'ログイン',
  ...
  # new for 2.10.0
  'Please wait, upgrading your database, do not interrupt' => 'お待ちください。データベースをアップグレード中です。中断してはいけません。',
  'purgerss' => 'RSS消去',
  'Purge RSS items' => 'RSSアイテムの消去',
  'In order to login, you need to enable cookies in your browser' => 'ログインするために、ブラウザのcookieを有効にする必要があります。',

  # added 2.10.2
  'globalvulnwarning' => 'このPHPのバージョンはセキュリティー上の大きな問題があります。 <br/>PHPの最新バージョンにアップグレードするのがベストです。この問題については<a href="http://www.hardened-php.net/globals-problem">ここ</a>を読んでください。',
