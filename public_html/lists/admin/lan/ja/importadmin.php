...
$lan = array(
  ...
  'Cannot find the email in the header' => 'ヘッダにメールアドレスを見つけることができません。',
  ...
  'password' => 'パスワード',
  'loginname' => 'ログイン名',
  'Empty loginname, using email:' => 'ログイン名が空です。メールアドレスを使用:',
  'Value' => '値',
  ...
  'All the emails already exist in the database' => 'すべてのメールアドレスは既にデータベースに存在しています。',
 ...
 <b>警告</b>: ファイルはプレーンテキストである必要があります。Wordドキュメントのようなバイナリファイルをアップロードしないでください。
  ...
  'importadmintestinfo' => 'もし、"テスト出力"をチェックするのであれば、あなたの画面上に解析されたメールアドレスのリストが表示されますが、データベースには情報は保存されないでしょう。これはあなたのファイルのフォーマットが正しいかどうかみつけるのに役立ちます。最初の50レコードのみ表示されるでしょう。',
  ...
  'testoutputinfo' => 'テスト出力:<br>1行につき1つのメールアドレスのみであるべきです。<br>もし出力がOKでしたら、本当に再送信するためには<a href="javascript:history.go(-1)">戻る</a>に行ってください。<br><br>',  
  'List for' => 'List for',
'login' => 'ログイン',
